...
; Stack Maps: 		Loc 3: Indirect 31+0	[encoding: .byte 3, .byte 0, .short 16, .short 31, .short 0, .int 0]
; Stack Maps: 		Loc 4: Indirect 31+0	[encoding: .byte 3, .byte 0, .short 16, .short 31, .short 0, .int 0]
; CHECK: .byte	3
; CHECK: .byte	0
; CHECK: .short 16
; CHECK: .short	31
...
; CHECK: .Ltmp1-test2
; Check for the two spill slots
; Stack Maps: 		Loc 3: Indirect 31+16	[encoding: .byte 3, .byte 0, .short 16, .short 31, .short 0, .int 16]
; Stack Maps: 		Loc 4: Indirect 31+0	[encoding: .byte 3, .byte 0, .short 16, .short 31, .short 0, .int 0]
; CHECK: .byte	3
; CHECK: .byte	0
; CHECK: .short 16
